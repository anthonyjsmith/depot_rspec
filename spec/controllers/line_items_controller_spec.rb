...
describe LineItemsController do
  ...
  let(:valid_attributes) { { product_id: Product.create!(title: "My Title", description: "A description.", price: 1.0, image_url: "img.jpg").id } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested line_item" do
        ...
        expect_any_instance_of(LineItem).to receive(:update).with({})
